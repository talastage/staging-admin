...
const emit = defineEmits<{
  ...
  (e: 'back'): void
  (e: 'confirm', data: { talent?: Role; categoryId: number; customRole?: string }): void
}>()
...
const handleConfirm = () => {
  ...
  const confirmData = {
    ...
    ...(roleInputMode.value === 'custom' || typeof selectedRole.value === 'string'
      ? { customRole: typeof selectedRole.value === 'string' ? selectedRole.value : selectedRole.value.name }
      : { talent: selectedRole.value }
    )
  }
