<template>
  <div class="categories-carousel">
    <BaseHeader title="Explore Categories" class="mb-3">
      <template #subtitle>
        Discover diverse talent categories for your project.
      </template>
      <template #actionable>
        <ViewAllButton
          route="/talents/categories"
          label="View All"
          color="primary"
        />
      </template>
...
import { useCategoriesCarousel } from '~/composables/useCategoriesCarousel'
